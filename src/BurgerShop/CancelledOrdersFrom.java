...
public class CancelledOrdersFrom extends javax.swing.JFrame {

    /**
     * Creates new form ViewCustomerForm
     *
     */
    public CancelledOrdersFrom() {
        initComponents();
        ...
        try {
            ...
            for (int i = 0; i < customerList.size(); i++) {
                ...
                if (customer.getStatus().equals("CANCELLED")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelledOrdersFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
