...
public class PreparingOrdersForm extends javax.swing.JFrame {

    /**
     * Creates new form ViewCustomerForm
     *
     */
    public PreparingOrdersForm() {
        initComponents();
        ...
        try {
            ...
            for (int i = 0; i < customerList.size(); i++) {
                ...
                if (customer.getStatus().equals("PREPARING")) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Preparing Orders");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreparingOrdersForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
